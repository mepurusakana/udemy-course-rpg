...
public class Object_Checkpoint : MonoBehaviour, ISaveable
{
    ...
    public void LoadData(GameData data)
    {
        ...
        bool active = Vector3.Distance(data.savedCheckpoint.ToVector3(), transform.position) < 0.01f;  //  修改 2
    ...
    public void SaveData(ref GameData data)
    {
        ...
        bool active = data.savedCheckpoint.ToVector3() == transform.position;  //  修改 3
    }
}